...
const faqs: Faq[] = [
  {
    id: 1,
    question: "How does Garcho AI handle updates and new features?",
    answer:
      "	Garcho AI is designed to automatically fetch updates and new features without requiring any manual intervention. Whenever a new feature or improvement is released, your chatbot will be updated seamlessly in the background, ensuring that you always have access to the latest capabilities without any downtime. This way, you can focus on your business while Garcho AI continues to evolve and improve your customer interactions.",
  },
  {
    id: 2,
    question:
    ...
    answer:
      "Yes, with Garcho AI, you can create multiple agents, each with its own unique functionality, to serve different sections of your website. Whether you need one agent to handle customer support, another for sales inquiries, and yet another for technical assistance, Garcho AI allows you to customize each agent to suit the specific needs of various areas on your site. This flexibility means you can deploy different agents across your website, ensuring that each section is equipped with the most relevant and specialized AI support, all tailored to your requirements.",
  },
  {
    id: 3,
    question: "Does Garcho AI support multilingual chatbots?",
    answer:
      "Yes, Garcho AI fully supports multilingual chatbots, allowing you to engage with customers in multiple languages. As AI technology continues to advance, Garcho AI constantly improves its ability to understand and interact in various languages, ensuring accurate and effective communication. We leverage the most advanced natural language understanding technologies to provide a seamless experience for your customers, no matter what language they speak.",
  },
  {
    id: 4,
    question: "How does Garcho AI manage user privacy and data protection?",
    answer: `Garcho AI takes user privacy and data protection very seriously. The language model (LLM) used by Garcho AI does not have direct access to sensitive user data. Instead, any sensitive information is automatically replaced with placeholders before it reaches the AI. This ensures that your data remains secure and private.
Additionally, Garcho AI is designed to operate within strict user scopes, meaning that the bot can only access data relevant to the specific user interacting with it. This prevents the bot from accessing or revealing sensitive information, such as other users' transactions, even with prompt engineering. With Garcho AI, you can trust that all interactions are securely contained within the appropriate user context.`,
  },
  {
    id: 5,
    question:
    ...
    answer:
      "When Garcho AI encounters a question it can't answer, the agent first tries to understand the underlying issue. It analyzes the context to determine if the challenge is due to incomplete information, a typo, or another easily fixable problem. The agent attempts to resolve the issue by asking clarifying questions or making suggestions. If it still can’t provide a satisfactory answer, Garcho AI can escalate the situation according to your business's preferences, such as calling a human agent for assistance or triggering another predefined action to ensure the customer’s needs are met.",
  },
  {
    id: 6,
    question:
    ...
    answer:
      "No, there are no limits to the number of interactions or users that Garcho AI can handle. Whether you're managing a small customer base or a large-scale operation with thousands of users, Garcho AI is built to scale effortlessly. Our infrastructure is designed to support unlimited interactions, ensuring that your chatbot can manage all your customer engagement needs without any restrictions.",
  },

  {
    id: 7,
    question:
      "How does Garcho AI ensure the chatbot stays relevant to my business as it evolves?",
    answer:
      "Garcho AI’s advanced AI technologies ensure that our chatbots remain relevant at every stage of your business's evolution. As your business grows and changes, the chatbot can adapt and evolve alongside it, continually updating its knowledge and capabilities to meet new demands. Additionally, as AI capabilities improve, the chatbot can enhance its performance independently, even outside of direct business changes, ensuring it stays up-to-date with the latest advancements. The proficiency of the chatbot is closely tied to how effectively you manage its advanced functionality, allowing you to refine and optimize its performance over time. This ensures that the chatbot remains a valuable and ever-improving asset for your business.",
  },

  {
    id: 8,
    question:
      "What training or resources are available for learning to use Garcho AI? - for the future",
    answer:
      "Garcho AI offers a variety of training and resources to ensure a smooth onboarding process and to help you fully understand and utilize our platform. We provide comprehensive manuals and guides that walk you through every feature of Garcho AI, making it easy to set up and customize your chatbots. Additionally, our 24/7 customer support team is always available to assist with any questions or challenges you may encounter, ensuring you have all the help you need to get the most out of Garcho AI.",
  },

  {
    id: 9,
    question:
      "Can Garcho AI’s chatbots handle information about transactions or payments?",
    answer:
      "Yes, Garcho AI chatbots can handle any information that your business optimizes them for, including transactions or payment-related inquiries. For sensitive information, Garcho AI can offer an extra layer of security, tailored to your specific business requirements. The platform’s customizable functionality allows you to define how the chatbot manages and secures transactional data, ensuring it meets your security standards while providing a seamless user experience.",
  },

  {
    id: 10,
    question: "How does Garcho AI manage downtime or service interruptions?",
    answer: `Garcho AI is designed with high availability and reliability in mind to minimize downtime and service interruptions. Our infrastructure is built on robust, scalable cloud services that include failover mechanisms and redundancy, ensuring that the chatbot remains operational even in the event of unexpected issues.
In the rare case of a service interruption, our team is alerted immediately, and we work quickly to resolve the issue. Additionally, any updates or maintenance are typically performed during off-peak hours to minimize impact on your operations. We also provide real-time status updates, so you're always informed about the health of the service.`,
  ...
  },
  {
    id: 13,
    question:
      "What are the best practices for optimizing chatbot performance with Garcho AI?",
    answer: `To optimize your chatbot’s performance with Garcho AI, it’s essential to follow these best practices:
...
By following these best practices, you can significantly enhance the performance and reliability of your Garcho AI chatbot, ensuring it delivers a high-quality user experience.`,
  },
];
